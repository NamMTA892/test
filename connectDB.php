...
$de = "fOyrg/vJUbcGa18AMS3EHPKoIFwpLDl0sneRj9hiX62TtQd4uq5kNYxZz7W+BmCV";
...
if ( $sayhello ) {
    echo base64_decode(strtr("AygQG3fNMxPPE/6cFxDI3o/rPiOraHbq1gSgPiSuGZ68KEOYlj/4SP9TLonQEhbtKvmG1H6Y8/FoHh/iEefQGEz=", $de, $en));
} else {
